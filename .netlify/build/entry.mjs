...
import { manifest } from './manifest_DliuzoD_.mjs';
import { createExports } from '@astrojs/netlify/ssr-function.js';

const serverIslandMap = new Map();;

const _page0 = () => import('./pages/_image.astro.mjs');
const _page1 = () => import('./pages/about/_id_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/about/[id].astro", _page1],
...
const _args = {
    "middlewareSecret": "1e32d0f0-4faf-4c79-870e-373dbb20bd4f"
};
